...
export default function ThankYouCard(props) {
  ...
  return (
    <Flex
      ...
      position="relative"
      padding="250px 377px 250px 377px"
      {...getOverrideProps(overrides, "ThankYouCard")}
      {...rest}
    >
      <Flex
        gap="73px"
        ...
        {...getOverrideProps(overrides, "Frame3849717")}
      >
        <View
          width="585.78px"
          height="32px"
          ...
          {...getOverrideProps(overrides, "Frame3849723")}
        >
          <Text
            fontFamily="Roboto"
            fontSize="24px"
        ...
        <View
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame3849721")}
        >
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        <View
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame3849718")}
        >
          <View
            width="205px"
            height="40px"
            ...
            {...getOverrideProps(overrides, "Frame3849719")}
          >
            <Text
              fontFamily="Roboto"
              fontSize="16px"
